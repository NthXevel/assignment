...
<div class="settings-page">
    <div class="settings-container">
        <h1><i class="fas fa-industry"></i> Create Product Factory</h1>
        <p>Define a new factory class and default specifications</p>
            ...
            <div class="settings-card">
                ...
                <form method="POST" action="{{ route('factories.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="factory_name" value="{{ old('factory_name') }}" placeholder="e.g. GamingLaptop" required>
                        <span class="text-muted" style="font-size: 12px; color: #666;">Creates class: App\\Factories\\Products\\<strong>{Name}</strong>Factory</span>
                    </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-theme btn-theme-primary">
                            <i class="fas fa-save"></i> Create Factory
                        </button>
...
<script>
    (function(){
        ...
        function addRow(key = '', value = '', type = 'string'){
            ...
            // Assign names to submit as nested specifications array
...
<style>
    ...
    .settings-card { background: white; padding: 25px; border-radius: 12px; box-shadow: 0 5px 20px rgba(0, 0, 0, 0.1); }
